...
SECRET_KEY = 'django-insecure-cywk(viziw&grk=wt1n69bjay*jr(7i4aa@$kfcdf9x)edz^n5'
...
WSGI_APPLICATION = 'login_sync.wsgi.application'
...
# REST Framework basic config (можно расширять по необходимости)
REST_FRAMEWORK = {
